...
class ListTicketToUpdateTile extends StatefulWidget {
  ...
  ListTicketToUpdateTile({this.docMainId, this.docId, this.date, this.depTime, this.arriveTime, this.yatayat, this.busType, this.ticketPrice,
    this.to, this.from, this.userEmailId, this.seats});
  @override
  _ListTicketToUpdateTileState createState() => _ListTicketToUpdateTileState();
}

class _ListTicketToUpdateTileState extends State<ListTicketToUpdateTile> {
  @override
