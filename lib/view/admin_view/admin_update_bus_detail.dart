...
class UpdateBusDetail extends StatefulWidget {
  ...
  String documentId, from, to, depTime, arrivalTime, travelCompany, busType, ticketPrice;
  UpdateBusDetail( this.documentId, this.depTime, this.arrivalTime, this.travelCompany, this.busType, this.ticketPrice);
  @override
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            RaisedButton(
              onPressed: () {
                fb.collection('BusDetail').doc(widget.documentId).update({
            ...
            RaisedButton(
              ...
              textColor: Colors.white,
              onPressed: () {
                fb.collection("BusDetail").doc(widget.documentId).delete();
                Navigator.pop(context);
              },
            )
          ],
